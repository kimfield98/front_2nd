...
type ApiFetchFunction = () => Promise<AxiosResponse<Lecture[]>>;
type CachedApiFetchFunction = () => Promise<AxiosResponse<Lecture[]>>;
...
const createCachedFetch = (
  fetchFn: ApiFetchFunction
): CachedApiFetchFunction => {
  return async () => {
...
const fetchMajors: ApiFetchFunction = () =>
  axios.get<Lecture[]>('/schedules-majors.json');
const fetchLiberalArts: ApiFetchFunction = () =>
...
const SearchDialog = ({ searchInfo, onClose }: Props) => {
  ...
  useEffect(() => {
    ...
    fetchAllLectures().then((results) => {
      ...
      console.log('강의 데이터가 성공적으로 로드되었습니다:', results);
    });
  }, []);
