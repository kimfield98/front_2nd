...
import { useCouponsData, useProductsData } from '../../refactoring/hooks';
...
describe('basic > ', () => {
  ...
  describe('useProducts > ', () => {
    ...
    test('특정 제품으로 초기화할 수 있다.', () => {
      const { result } = renderHook(() => useProductsData(initialProducts));
  ...
  describe('useCoupons > ', () => {
    test('쿠폰을 초기화할 수 있다.', () => {
      const { result } = renderHook(() => useCouponsData(mockCoupons));
